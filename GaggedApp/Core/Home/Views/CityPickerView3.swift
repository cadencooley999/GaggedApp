//
//  CityPickerView 2.swift
//  GaggedApp
//
//  Created by Caden Cooley on 2/9/26.
//
import SwiftUI
import Foundation

struct CityPickerView3: View {
        ...
        ZStack {
            ...
            VStack {
                ...
                ZStack {
                    ...
                    VStack {
                        Spacer()
                        BackgroundHelper.shared.appleFooterBlur.frame(height: 55)
                    }
                    VStack {
                        Spacer()
                        footer
    ...
    var citiesSection: some View {
        VStack(spacing: 16) {
            // Current City
            if locationManager.selectedCity != nil {
                Text("Current City")
    ...
    func cityTapped(city: City) {
        ...
        Task {
            settingsViewModel.nameMentionCity = city
        }
